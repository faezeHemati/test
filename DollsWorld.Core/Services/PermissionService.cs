...
using DollsWorld.DataLayer.Entities.Permissions;
...
namespace DollsWorld.Core.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public PermissionService(DollsWorldContext context)
        {
            _context = context;
        }
        ...
        public int AddRole(Role role)
        {
            ...
            return role.RoleId;
        }  // چون قرار است کد نقش برگردانده شود به صورت اینت تعریف می شود 
        ...
        public void AddRolesToUser(List<int> roleIds, int userId)  // به کدام آیدی کاربر باید این نقش ها اضافه شود
        {
