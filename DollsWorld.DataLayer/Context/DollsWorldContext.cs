...
namespace DollsWorld.DataLayer.Context
{
   public class DollsWorldContext:DbContext
    {

        public DollsWorldContext(DbContextOptions<DollsWorldContext> options):base(options)
        {
