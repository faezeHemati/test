...
namespace DollsWorld.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DollsWorldContext>(options =>
            {
                options.UseSqlServer(Configuration.GetConnectionString("DollsWorldConnection"));
            }
            );
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //app.UseMvc(routes =>    // این روت ام وی سی هست که ریزر پیج ها در دسترس هستند .
            //{
            //    routes.MapRoute(
            //        name: "areas",
